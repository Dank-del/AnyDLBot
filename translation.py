class Translation(object):
    START_TEXT = """Welcome to Reno! An all in one downloader bot. Do /help to check out my features"""
    RENAME_403_ERR = "Sorry. You are not permitted to rename this file."
    ABS_TEXT = " Please don't be selfish."
    UPGRADE_TEXT = "Open Source <a href='https://github.com/Dank-del/AnyDLBot'>code</a>. \nStart @RenoDLbot to know Paid Plans!"
...
👉 <a href="https://t.me/RenoDLbot">Convert To Streamable Video, any Telegram file</a>
👉 <a href="https://t.me/RenoDLbot">Convert To Telegram Audio, the media sent as Telegram Documents</a>
